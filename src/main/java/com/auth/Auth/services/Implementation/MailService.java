...
public class MailService {
    ...
    public void sendOtpEmail(String toEmail, String otp) {
        try {
            ...
            helper.setFrom(fromAddress, "Authenticator App");
            helper.setTo(toEmail);
            helper.setSubject("Your Authenticator App verification code");
                          ...
                          <tr>
                            <td style="padding: 24px 32px 32px 32px;">
                              <p style="margin:0; font-size: 12px; line-height: 18px; color:#52525b;">
                                This is an automated message from Authenticator App. Please don't reply to this email.
                              </p>
                            </td>
                          </tr>
